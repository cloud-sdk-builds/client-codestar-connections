...
[`@aws-sdk/client-codestar-connections`](https://www.npmjs.com/package/@aws-sdk/client-codestar-connections/v/3.473.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codestar-connections@3.473.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cOSEnaKsPToJL584PPH1mGeHMt9Hol8dqb04xbR/AtNt+c2y+IWKnromr76aB16t
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-codestar-connections": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codestar-connections@3.473.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codestar-connections@3.473.0/index.min.mjs": "sha384-cOSEnaKsPToJL584PPH1mGeHMt9Hol8dqb04xbR/AtNt+c2y+IWKnromr76aB16t"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-codestar-connections/blob/refs/tags/3.473.0/LICENSE
```
